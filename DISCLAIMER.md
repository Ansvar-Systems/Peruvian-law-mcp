...
- **Professional Rules**: Members of the Colegio de Abogados del Perú and the Junta de Decanos de los Colegios de Abogados del Perú must comply with applicable professional conduct rules (Código de Ética del Abogado) when using AI tools
...
1. Checking the official source (SPIJ — Sistema Peruano de Información Jurídica, spij.minjus.gob.pe; Ministry of Justice — minjus.gob.pe)
2. Verifying the provision is currently in force (vigente) and has not been amended (modificado) or repealed (derogado)
...
This Tool aggregates data from official Peruvian legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **spij.minjus.gob.pe** | Authoritative | Statute text, laws, decrees, regulations (primary reference) |
| **El Peruano (diariooficialperu.com)** | Authoritative | Official gazette, notifications, statutory instruments |
| **Congreso de la República (congreso.gob.pe)** | Authoritative | Parliamentary records, law texts |
...
- Gaceta Jurídica, Legis.pe, Ius et veritas legal resources
...
- Peruvian law changes continuously through new laws (leyes), legislative decrees (decretos legislativos), supreme decrees (decretos supremos), and court decisions (sentencias)
...
- Even "fresh" data may be outdated if recent amendments were published in El Peruano
...
1. **Complete case law** -- Coverage of the Supreme Court of Justice (Corte Suprema de Justicia), Constitutional Court (Tribunal Constitucional), and lower court decisions is limited; do not rely solely on this for jurisprudence research
...
5. **Full legislative history** -- Limited coverage of congressional debates (exposición de motivos) and committee reports (dictámenes)
...
- **International Law Blind Spots**: Cannot fully assess obligations under international treaties Peru has ratified, including Andean Community instruments
...
- This includes but is not limited to:
  - Professional malpractice claims (responsabilidad civil del abogado)
...
- Provide competent representation (patrocinio diligente)

## Recommended Workflow for Professional Use

1. **Initial Research**: Use Tool for preliminary research and hypothesis generation
2. **Official Verification**: Cross-check ALL results with official sources (spij.minjus.gob.pe, El Peruano)
3. **Commercial Databases**: Use professional legal databases (Gaceta Jurídica, Legis.pe) for authoritative, annotated versions
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Peruvian-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Peruvian-law-mcp/issues
...
- **ALWAYS VERIFY** all legal information with official sources (spij.minjus.gob.pe)
...
- **COMPLY** with Colegio de Abogados del Perú / Junta de Decanos professional ethics rules regarding AI tool use and client confidentiality
- **DISCLOSE** to clients if required by professional rules (Código de Ética del Abogado)

/**
 * Tool registry for Peruvian Law MCP Server.
...
import { getPeruvianImplementations, type GetPeruvianImplementationsInput } from './get-peruvian-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including the El Peruano (Diario Oficial). ' +
    ...
    'Call this FIRST when you need to understand what Peruvian legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Peruvian statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (section) from a Peruvian statute. ' +
  ...
  },
  {
    ...
    description:
      'Validate a Peruvian legal citation against the database — zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Peruvian statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Peruvian?" ' +
  ...
  },
  {
    ...
    description:
      'Format a Peruvian legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether a Peruvian statute or provision is currently in force, amended, repealed, or not yet in force. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get international legal instruments that a Peruvian statute references or aligns with. ' +
      'Peruvian laws may reference international standards and conventions ' +
      'where applicable. ' +
      'Returns EU document identifiers, reference types, and implementation status.',
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Peruvian statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_peruvian_implementations',
    description:
      'Find all Peruvian statutes that reference or align with a specific EU directive or regulation. ' +
      'Given an EU document ID (e.g., "regulation:2016/679" for GDPR), returns matching Peruvian statutes. ' +
      'Peruvian may reference international legal instruments where relevant.',
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that are referenced by Peruvian legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_peruvian_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents referenced by Peruvian legislation.',
        },
  ...
  },
  {
    ...
    description:
      'Get the EU legal basis for a SPECIFIC provision within a Peruvian statute. ' +
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_peruvian_implementations':
          result = await getPeruvianImplementations(db, args as unknown as GetPeruvianImplementationsInput);
          break;
